...
<body onload="onLoadGetId()">
	...
	<main class="container-fluid">
		<a href="DisplayStudentHomePage.jsp">Previous page</a><br /> <br />
	...
	<script>
		...
		function getFeesFromServlet(studentRollNumber){
			...
			fetch(url,{method:'get'}).then(res=> res.json()).then(res=>{
				let data = res;
				console.log(data);
				var tableData = '<thead class="thead-dark"><tr><th>S.no</th><th scope="col">MONTH</th><th scope="col">FEES AMOUNT (Rs)</th><th scope="col">RECEIVE DATE</th></tr></thead>'
					tableData+= '<tbody>'
