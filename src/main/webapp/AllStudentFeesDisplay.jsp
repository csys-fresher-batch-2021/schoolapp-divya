...
<body onload="onLoadGetId()">
	...
	<main class="container-fluid">
		<a href="DisplayStaffHomePage.jsp">Previous page</a><br /> <br />
	...
	<script>
		/**
		 *This method fetches the all fees data  from the servlet and gets a json data from the servlet, and writes those json data to the html. 
		 */
		function getFeesFromServlet(){
			let url = "StudentAllFeesDetailsDisplayServlet?";
			fetch(url,{method:'get'}).then(res=> res.json()).then(res=>{
				let data = res;
				console.log(data);
				var tableData = '<thead class="thead-dark"><tr><th>S.no</th><th scope="col">STUDENT ROLL NUMBER</th><th scope="col">MONTH</th><th scope="col">FEES AMOUNT (Rs)</th><th scope="col">RECEIVE DATE</th></tr></thead>'
					tableData+= '<tbody>'
