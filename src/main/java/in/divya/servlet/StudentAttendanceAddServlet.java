...
import in.divya.service.StudentAttendanceAddService;
...
/**
 * Servlet implementation class StudentAttendanceAddServlet
 */
@WebServlet("/StudentAttendanceAddServlet")
public class StudentAttendanceAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public StudentAttendanceAddServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			StringValidatorUtil.isStringNotNullOrEmpty(studentReason, "Cannot Accept Empty and Null Value...Please Enter Nil");


			/**
			 * Step 2: Call Service => add student attendance details
			 */
			...
			boolean isAddedAttendance = StudentAttendanceAddService.addAttendance(attendance);

			/**
			 * Step 3: Decide to which page we should redirect ?
			 */
			if (isAddedAttendance) {
				String message = "SUCCESSFULLY ATTENDANCE ADDED";
			...
			e.printStackTrace();
			RequestDispatcher rd = request.getRequestDispatcher("StudentAttendanceAdd.jsp?errorMessage=" + e.getMessage());
